...
// import Project from 'components/Comp' // if you want to use the `Card` comp instead of the other one

export async function getStaticProps() {
	const { frontmatter, source } = await getFileContent('research.mdx')
